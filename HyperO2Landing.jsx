      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-16 items-center w-full">
        <div>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6 text-xs font-semibold tracking-widest uppercase"
            ...
            <Activity size={12} />
            Terapia Hiperbaryczna mHBOT · Sosnowiec
          </div>
          ...
          <div className="flex gap-8 mt-12 pt-8" style={{ borderTop: "1px solid rgba(255,255,255,0.12)" }}>
            {[["5★", "Ocena Google"], ["15×", "Więcej tlenu w organizmie"], ["mHBOT", "Certyfikowana komora"]].map(([v, l]) => (
              <div key={l}>
...
function WhyOxygen() {
  const benefits = [
    {
      icon: Zap, color: "#F59E0B", bg: "#FEF3C7", title: "Sport & Regeneracja",
      desc: "Znaczący wzrost wydolności płuc — oddechy głębsze, szybszy powrót do treningu.",
      points: ["Szybsze usuwanie kwasu mlekowego", "Naprawa mikrouszkodzeń mięśni", "Krótszy czas powrotu po kontuzji"],
    },
    {
      icon: Shield, color: "#10B981", bg: "#D1FAE5", title: "Zdrowie & Odporność",
      desc: "Sprawdzona metoda przyspieszonej regeneracji dzięki 100% tlenowi medycznemu.",
      points: ["Wsparcie gojenia ran i tkanek", "Wzmocnienie układu immunologicznego", "Redukcja stanów zapalnych"],
    },
    {
      icon: Sparkles, color: "#EC4899", bg: "#FCE7F3", title: "Beauty & Anti-Aging",
      desc: "Tlen pobudza syntezę kolagenu — efekty widoczne już po kilku sesjach.",
      points: ["Redukcja zmarszczek i przebarwień", "Poprawa elastyczności i blasku skóry", "Naturalne spowolnienie starzenia"],
    },
    {
      icon: Moon, color: "#6366F1", bg: "#EEF2FF", title: "Wellness & Relaks",
      desc: "Świetny sposób regeneracji po długim i męczącym dniu.",
      points: ["Głębszy i spokojniejszy sen", "Lepsza koncentracja i jasność umysłu", "Redukcja stresu i poziomu kortyzolu"],
    },
  ];

  return (
    <section id="tlenoterapia" className="py-36 px-6" style={{ background: "#F8FBFF" }}>
      <div className="max-w-6xl mx-auto">
        <FadeSection>
          <div className="text-center mb-20">
            ...
            <p className="mt-4 text-base leading-relaxed mx-auto" style={{ color: "#4A6580", maxWidth: "660px" }}>
              Pod podwyższonym ciśnieniem tlen rozpuszcza się bezpośrednio w osoczu krwi — do organizmu trafia nawet{" "}
              <strong style={{ color: "#1B3F8A" }}>15 razy więcej tlenu</strong> niż przy normalnym oddychaniu,
              docierając tam, gdzie krew normalnie nie dopływa. To regeneracja na poziomie komórkowym.
            </p>
          </div>
        </FadeSection>
            ...
            <FadeSection key={b.title} delay={i * 80}>
              <div
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = "0 20px 48px rgba(14,66,120,0.14)";
                }}
                onMouseLeave={e => {
              ...
              >
                ...
                <h3 className="font-semibold mb-2" style={{ color: "#071E3D", fontSize: "1rem" }}>{b.title}</h3>
                <p className="text-sm leading-relaxed mb-4" style={{ color: "#607D96" }}>{b.desc}</p>
                <ul className="flex flex-col gap-2">
                  {b.points.map(pt => (
                    <li key={pt} className="flex items-start gap-2 text-xs leading-relaxed" style={{ color: "#4A6580" }}>
        ...
        <FadeSection delay={400}>
          <div className="text-center mt-14">
            <a href="#oferta"
              className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full font-semibold text-sm transition-all hover:scale-105"
              style={{ background: "linear-gradient(135deg,#1B3F8A,#00AEEF)", color: "white", boxShadow: "0 8px 28px rgba(27,63,138,0.3)" }}>
...
function Pricing() {
  const plans = [
    ...
    {
      icon: Package, tag: "Oszczędzasz 200 zł",
      title: "Pakiet 10 wejść", price: "1 100", unit: "zł / 10 sesji",
      desc: "Najchętniej wybierany pakiet — pełny cykl regeneracyjny dla trwałych i widocznych efektów.",
    ...
    {
      icon: Award, tag: "Najlepsza wartość",
      title: "Pakiet 25 wejść", price: "2 000", unit: "zł / 25 sesji",
      desc: "Dla osób szukających długofalowych efektów — najkorzystniejsza cena za sesję.",
      features: ["25 × 60 minut", "Oszczędzasz aż 1 250 zł", "Priorytetowe rezerwacje", "Dedykowany opiekun", "Pełny program regeneracji"],
      cta: "Wybierz pakiet 25", accent: "#00AEEF", featured: false,
    },
  ];

  return (
    <section id="oferta" className="py-36 px-6" style={{ background: "white" }}>
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch">
          {plans.map((p, i) => (
            <FadeSection key={p.title} delay={i * 100}>
              <div className="relative rounded-3xl flex flex-col h-full"
                style={{
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = p.featured
                    ? "0 32px 72px rgba(27,63,138,0.5)"
                    : "0 20px 48px rgba(14,66,120,0.15)";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.transform = "translateY(0)";
                  e.currentTarget.style.boxShadow = p.featured
                    ? "0 20px 60px rgba(27,63,138,0.35)"
                    : "0 2px 20px rgba(14,66,120,0.07)";
                }}
              >
                {p.tag && (
...
function Safety() {
  ...
  return (
    <section id="bezpieczeństwo" className="py-36 px-6" style={{ background: "#F0F6FD" }}>
        ...
        <FadeSection delay={150}>
          <div className="rounded-2xl p-6" style={{ background: "white", border: "1px solid #E0ECFA", boxShadow: "0 4px 24px rgba(14,66,120,0.08)" }}>
            ...
            <p className="text-xs mt-5 pt-4 leading-relaxed" style={{ color: "#8FA5BC", borderTop: "1px solid #EAF0F8" }}>
              * Ostateczną kwalifikację do zabiegu przeprowadza wykwalifikowany personel Komory Hiperbarycznej Śląsk Sosnowiec (mHBOT).
            </p>
          </div>
        </FadeSection>
      </div>
...
function Testimonials() {
  ...
  return (
    <section id="opinie" className="py-36 px-6" style={{ background: "white" }}>
      <div className="max-w-5xl mx-auto">
        <FadeSection>
