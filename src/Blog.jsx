...
import { ArrowLeft, ArrowRight, Clock, Tag, Calendar, Search, ChevronRight, Wind, Phone } from "lucide-react";

const LOGO_SRC = ""; // zostanie podmienione
  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "2rem 1.5rem" }}>
      ...
      <div style={{ marginTop: "3rem", padding: "2rem", borderRadius: 20, background: "linear-gradient(135deg,#071E3D,#1B3F8A)", textAlign: "center" }}>
        ...
        <a href="tel:+48608531549" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "0.875rem 2rem", borderRadius: 99, fontWeight: 600, fontSize: "0.875rem", color: "white", textDecoration: "none", background: "linear-gradient(135deg,#00AEEF,#0e7abf)", boxShadow: "0 6px 20px rgba(0,174,239,0.4)" }}>
